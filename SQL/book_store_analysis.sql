...
FROM 'E:\postgreSQL learning\OnlineBookStore\Books.csv'
CSV HEADER;

--import data to Customers table
COPY Customers(Customer_ID, Name, Email, Phone, City, Country) 
FROM 'E:\postgreSQL learning\OnlineBookStore\Customers.csv' 
CSV HEADER;

--import data to Orders table
COPY Orders(Order_ID, Customer_ID, Book_ID, Order_Date, Quantity, Total_Amount) 
FROM 'E:\postgreSQL learning\OnlineBookStore\Orders.csv' 
CSV HEADER;
